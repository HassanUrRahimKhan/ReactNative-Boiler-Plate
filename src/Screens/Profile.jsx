    ...
    <>
      <ScrollView>
        <View style={[styles.h100, styles.bgWhite]}>
          ...
          <Text style={[styles.mt1, styles.textBlack, { fontSize: 23 }, styles.textBold, styles.textCenter]}>Hassan Ur Rahim</Text>
          <Text style={[styles.textCenter, styles.fs5, { color: 'grey' }]}>hassan.rahim</Text>
          ...
          <View style={[styles.flexRow, styles.my2]}>
            <View>
              <View style={[{ marginLeft: 90 }]}>
                <HMIcon name="schedule" size={30} color="black" />
              </View>
            ...
            <View>
              <View style={[{ marginLeft: 101 }]}>
                <HMIcon name="check-circle-outline" size={30} color="black" />
              </View>
          ...
          <View style={[styles.flexColumn, styles.p2, styles.py]}>
            <TouchableOpacity onPress={() => navigation.navigate('ProjectsScreen')} style={[styles.flexRow, styles.border1, { padding: 15, paddingTop: 18, borderColor: "darkgrey", borderRadius: 15 }]}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('CreateteamScreen')} style={[styles.mt1, styles.flexRow, styles.border1, { padding: 15, paddingTop: 18, borderColor: "darkgrey", borderRadius: 15 }]}>
            ...
            <TouchableOpacity style={[styles.mt1, styles.flexRow, styles.border1, { padding: 15, paddingTop: 18, borderColor: "darkgrey", borderRadius: 15 }]} onPress={() => navigation.navigate('CreateTaskScreen')}>
