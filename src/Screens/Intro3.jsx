    ...
    return (
        <>
            ...
            <View style={[styles.flexRow, styles.mt2]}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('signinScreen')} style={[styles.bgPrimary, styles.flexCenter, styles.w100, { marginLeft: 180, height: 150, width: 110, marginTop: -40, borderTopLeftRadius: 250, borderBottomLeftRadius: 150 }]}>
